namespace Ergasia3.src.Frontend.ConcertHall
{
	partial class SignUp
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel1.Size = new Size( 452, 520 );
			...
			this.signUpButton.Location = new Point( 54, 417 );
			...
			this.passwordTextBox.Location = new Point( 54, 309 );
			this.passwordTextBox.MaxLength = 32;
			this.passwordTextBox.Name = "passwordTextBox";
			this.passwordTextBox.PasswordChar = '*';
			this.passwordTextBox.Size = new Size( 341, 43 );
			...
			this.label1.Location = new Point( 150, 6 );
			...
			this.emailTextBox.Location = new Point( 55, 211 );
			...
			this.usernameTextbox.Location = new Point( 55, 109 );
