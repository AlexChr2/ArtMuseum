namespace Ergasia3.Source.Frontend.DJockeyHall
{
	partial class DJHall
	{
		...
		private void InitializeComponent()
		{
			...
			// panel6
			// 
			this.panel6.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel6.Controls.Add( this.panel5 );
			this.panel6.Controls.Add( this.panel7 );
			this.panel6.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel5
			// 
			this.panel5.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel5.Controls.Add( this.panel15 );
			this.panel5.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel15
			// 
			this.panel15.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel15.Controls.Add( this.SignUpLbl );
			this.panel15.Controls.Add( this.label3 );
			this.panel15.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			this.SignUpLbl.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.SignUpLbl.Font = new Font( "Lucida Console", 16.2F, FontStyle.Bold, GraphicsUnit.Point,   0 );
			this.SignUpLbl.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel7
			// 
			this.panel7.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel7.Controls.Add( this.panel4 );
			this.panel7.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel4
			// 
			this.panel4.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel4.Controls.Add( this.panel3 );
			this.panel4.Controls.Add( this.panel2 );
			this.panel4.Controls.Add( this.panel1 );
			this.panel4.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel3
			// 
			this.panel3.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel3.Controls.Add( this.mediaPlayer );
			this.panel3.Controls.Add( this.songsListView );
			this.panel3.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel2
			// 
			this.panel2.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel2.Controls.Add( this.panel20 );
			this.panel2.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel10
			// 
			this.panel10.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel10.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// BuyBtn
			// 
			this.BuyBtn.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.BuyBtn.Font = new Font( "Lucida Calligraphy", 10.8F, FontStyle.Bold, GraphicsUnit.Point,   0 );
			this.BuyBtn.ForeColor = Color.FromArgb(     127,     237,     242,     244 );
			...
			// panel1
			// 
			this.panel1.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel1.Controls.Add( this.panel9 );
			this.panel1.Controls.Add( this.panel8 );
			this.panel1.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel9
			// 
			this.panel9.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			...
			this.panel9.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// nextSongBtn
			// 
			this.nextSongBtn.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.nextSongBtn.Font = new Font( "Lucida Bright", 13.8F, FontStyle.Bold, GraphicsUnit.Point,   0 );
			this.nextSongBtn.ForeColor = Color.FromArgb(     127,     237,     242,     244 );
			...
			// prevSongBtn
			// 
			this.prevSongBtn.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.prevSongBtn.Font = new Font( "Lucida Bright", 13.8F, FontStyle.Bold, GraphicsUnit.Point,   0 );
			this.prevSongBtn.ForeColor = Color.FromArgb(     127,     237,     242,     244 );
			...
			// pauseButton
			// 
			this.pauseButton.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.pauseButton.Font = new Font( "Lucida Bright", 16.2F, FontStyle.Bold, GraphicsUnit.Point,   0 );
			this.pauseButton.ForeColor = Color.FromArgb(     127,     237,     242,     244 );
			...
			// panel16
			// 
			this.panel16.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel16.Controls.Add( this.panel14 );
			this.panel16.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel14
			// 
			this.panel14.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel14.Controls.Add( this.label1 );
			this.panel14.Controls.Add( this.Volume_scrollbar );
			this.panel14.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			this.label1.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.label1.FlatStyle = FlatStyle.Flat;
			this.label1.Font = new Font( "Lucida Bright", 13.8F, FontStyle.Bold, GraphicsUnit.Point,   0 );
			this.label1.ForeColor = Color.FromArgb(     127,     237,     242,     244 );
			...
			// panel11
			// 
			this.panel11.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel11.Controls.Add( this.panel21 );
			this.panel11.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel21
			// 
			this.panel21.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel21.Controls.Add( this.DJAudioPbx );
			this.panel21.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// DJAudioPbx
			// 
			this.DJAudioPbx.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.DJAudioPbx.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel8
			// 
			this.panel8.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel8.Controls.Add( this.panel12 );
			this.panel8.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel12
			// 
			this.panel12.BackColor = Color.FromArgb(     127,     43,     45,     66 );
			this.panel12.Controls.Add( this.panel17 );
			this.panel12.Controls.Add( this.panel13 );
			this.panel12.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			// panel17
			// 
			this.panel17.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel17.Controls.Add( this.label5 );
			this.panel17.Controls.Add( this.BPM_textLbl );
			this.panel17.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
			...
			this.BPM_textLbl.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			...
			this.BPM_textLbl.ForeColor = Color.FromArgb(     127,     43,     45,     66 );
			...
			// panel13
			// 
			this.panel13.BackColor = Color.FromArgb(     127,     141,     153,     174 );
			this.panel13.Controls.Add( this.playingSongLbl );
			this.panel13.ForeColor = Color.FromArgb(     127,     0,     0,     0 );
