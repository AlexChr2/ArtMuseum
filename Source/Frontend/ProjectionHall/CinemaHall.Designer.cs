namespace Ergasia3.Source.Frontend.CinemaHall
{
	partial class CinemaHall
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Location = new Point( 533, 299 );
			this.button1.Margin = new Padding( 3, 2, 3, 2 );
			this.button1.Name = "button1";
			this.button1.Padding = new Padding( 5, 0, 0, 2 );
			this.button1.Size = new Size( 94, 50 );
			...
			this.button2.Location = new Point( 55, 299 );
			this.button2.Margin = new Padding( 3, 2, 3, 2 );
			this.button2.Name = "button2";
			this.button2.Padding = new Padding( 0, 0, 3, 2 );
			this.button2.Size = new Size( 94, 50 );
			...
			this.button4.Location = new Point( 248, 299 );
